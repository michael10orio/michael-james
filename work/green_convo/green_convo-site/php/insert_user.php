...
if ($dbi) {
    ...
    $q = "INSERT INTO Green_Convo_Clients (Name, Alias, Password) VALUES (?, ?, ?)"; // Write a query to add a new user in your table
    ...
    if ($insertStmt = $dbi->prepare($q)) {
        ...
        $insertStmt->bind_param("sss", $Name, $Alias, $Password);//Here put the code to setup the bind_param
        $insertStmt->execute();
